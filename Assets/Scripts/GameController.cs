...
public class GameController : MonoBehaviour
{
    ...
    public void OnClick() 
    {
        ...
        //TODO Jak kończy się życie nic się nie dzieje
    ...
    public int CountCows()
    {
        ...
        for (int i = 0; i < Word.Length; i++)
        {
            // || (or) conajmniej jedna ze stron jest true ==> true
            // && (and) warunki po lewej i po prawej powinny być true ==> true, else false
